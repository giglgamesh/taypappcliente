 ...
 */
public class PSliderData implements Parcelable {
    ...
    protected PSliderData(Parcel in) {
        id = in.readInt();
        cat_id = in.readInt();
    ...
    public static final Creator<PSliderData> CREATOR = new Creator<PSliderData>() {
        @Override
        public PSliderData createFromParcel(Parcel in) {
            return new PSliderData(in);
        }

        @Override
        public PSliderData[] newArray(int size) {
            return new PSliderData[size];
        }
    };
}